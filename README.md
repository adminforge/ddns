...
| ddns                        | DDNS_BLOCKED_HOSTNAMES | empty              | no | Comma-separated list of hostnames (e.g. `abused,phishing`) that can neither be registered nor updated and do not resolve, even if still present in Redis. Useful for abuse handling. |
